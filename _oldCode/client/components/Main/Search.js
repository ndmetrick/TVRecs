...
const Search = (props) => {
		...
		if (props.currentUser) {
			...
			props.userShows.forEach((userShow) => {
				...
				if (showNames[showName]) {
					...
					showName = `${userShow.show.name} (${userShow.show.tmdbId})`;
				}
	...
	const chooseShowToSearch = (showName, tmdbId, filterShowChosen) => {
		setShowName(showName);
		setChosenShow(tmdbId);
										...
										<View>
											...
											{sameShowName ? (
												...
												>
													...
													name, we have added the TMDB ID to the end of any
													duplicate names.
												</Text>
											) : null}
										</View>
